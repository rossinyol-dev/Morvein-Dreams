...
define config.name = _("Morvein Dreams")
...
define config.version = "0.1.0.4-beta"


## Текст, помещённый в экран "Об игре". Поместите текст между тройными скобками.
## Для отделения абзацев оставляйте между ними пустую строку.

define gui.about = _p("""Сны Морвейна. История о пробуждении.""")

define build.name = "MorveinDreams"
...
define config.save_directory = "MorveinDreams-1779781399"
...
define build.itch_project = "rossinyol.itch.io/morvein-dreams"
