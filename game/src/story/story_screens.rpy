...
label tutorial_text:
    ...
    narrator "Игра сохраняется автоматически, поэтому последствия ваших решений необратимы."
...
transform act_title_fade(display_time=3.8):
    alpha 0.0
    yoffset 18
...
screen act_title_screen(act_title, act_subtitle=None, display_time=3.8):
    ...
    vbox at act_title_fade(display_time):
        xalign 0.5
        yalign 0.48
        spacing 28
