...
label act_1_investigation_tavern_song:
    ...
    call cinematic_narrator("{i}По горным пикам ходит тихо{i}\С котомкою борей.", 7.5, 1.0, centered=True)
    ...
    call cinematic_narrator("Кажется, это все было слишком давно... И с другим человеком...", 10.0, 1.5)
    $ renpy.pause(4.0, hard=True)
    call cinematic_narrator("Когда песня начинает затихать, ты с трудом возврашаешься обратно. В глазах сидящих рядом с тобой стоят слезы восхищения.", 6.0, 1.5)
    ...
    narrator "Потом зал взрывается апплодисментами. Девушка улыбается, кланяется и исчезает так же тихо, как появилась."
