...
label act_1_start:
    ...
    $ add_glossary_entry(
        "morvein",
        "Морвейн",
        "Приграничный город королевства Эстервальд. Большинство "
    )
    $ add_glossary_entry(
        "order",
        "Орден",
        "Монашеская власть Морвейна, которая веками удерживает город в жесткой дисциплине. Орден говорит о защите и спасении, но его архивы, певцы и тайные решения все чаще указывают на правду, которую Совет скрывает даже от собственных служителей."
    )
    $ add_glossary_entry(
        "beggar",
        "Нищий",
        "Безумный бродяга, которого герой встретил у входа в собор перед ночной службой.",
        # "images/misc/beggar_sketch_face.png"
    )
    $ add_glossary_entry(
        "stefan",
        "Отец Стефан",
        "Настоятель Ордена в Морвейне. Он пытался удержать лунатиков во время пробуждениях спящих, но был тяжело ранен нищим у главных ворот.",
        # "images/misc/stefan_sketch_face.png"
    )
    $ add_glossary_entry(
        "mattias",
        "Брат Маттиас",
        "Монах, присматривающий за храмовой лечебницей. Маттиас выглядит мягче многих братьев Ордена.",
        # "images/misc/mattias_sketch_face.png"
    )
    $ add_glossary_conditional_note(
        "beggar",
        beggar_flag_help,
        "Герой сжалился над беднягой, дав ему монетку у дверей собора. Той же ночью во время пробуждения спящих нищий напал на отца Стефана, но не решился атаковать тебя. Кажется, твое милосердие спасло тебе жизнь...",
        "Герой проигнорировал беднягу у дверей собора. Той же ночью нищий во время пробуждения спящих напал на тебя и отца Стефана. Кто знает, как бы все повернулось, сжалься ты над калекой.."
    )
    $ add_glossary_conditional_note(
        "stefan",
        stefan_saved_flag,
        "После нападения нищего ты сразу доставил отца Стефана в собор. Благодаря этому настоятель выжил и быстро оправился от ран.",
        "После нападения нищего отец Стефан остался жив, но его состояние крайне тяжелое. Братья Ордена борются за жизнь настоятеля."
    )
...
label act_1_investigation_agatha:
    ...
    narrator "За ним хлопочет невысокая бойкая торговка в красной шали и плятке, повязанном на голову."
