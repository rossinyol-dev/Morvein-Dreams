...
label act_1_investigation_well_descent:
    ...
    narrator "Ты снова подходишь к краю старого колодца."
    narrator "Воспоминания о произошедшем заставляют тебя на мгновение взрогнуть."
    narrator "Крепко ухватившись за прочную веревку, ты осторожно начинаешь спускаться во тьму."
...
label act_1_investigation_inside_well:
    ...
    narrator "По её контуру едва заметно мерцают странные, почти потухшие символы в форме разных фаз луны."
    narrator "Прямо под аркой находится массивная каменная плита. Судя по следам на земле, она явно сдвигалась с места совсем недавно."
    ...
    narrator "Следы почти свежие, будто кто-то проходил здесь день-два назад."
    narrator "Кажется, безумная гипотеза, что спящие могли уйти ночью через подземные лазы, может оказаться не такой безумной..."
    narrator "Через пару минут, изучив остальную пещеру, ты понимамешь, что сейчас здесь делать больше нечего."
    narrator "Ты хватаешься за веревку и выбираешься обратно на свежий воздух."

    $ hard_fade("morvein_well_alley")

    $ dream_char("albert default", [center])

    narrator "Прямо у колодца перед тобой стоит Альберт, нетерпеливо переминаясь с ноги на ногу."
    albert "Ну как, нашли что-нибудь интересненькое?"
    narrator "Ты киваешь Альберту и, отряхнув испачканные ладони, молча направляешься обратно в сторону таверны."

label act_1_investigation_tavern_meeting:
    $ hard_fade("morvein_tavern")

    narrator "Вы возвращаетесь в заполненный больше прежнего зал вместе с Альбертом."
    narrator "Он идет рядом, то и дело бросая на тебя тревожные взгляды."
    ...
    narrator "Перед Виллемом стоит человек, как две капли воды похожий на того самого незнакомца, что увел тебя к колодцу."
    narrator "Ты резко подходишь к стойке, заставив Альберта поспешить следом."
    narrator "Виллем не успевает произнести ни слова, когда ты резко обращаешься к незнакомцу и обвиняешь в том, что из-за него сегодня едва не погиб."
    ...
    rykard_guard_unarmed "Я не имею привычки разгуливать по бедным кварталам Морвейна."
    ...
    narrator "Убедившись, что напряжение снято, Виллем продолжает."
    ...
    rykard_guard_unarmed "Мой хозяин, господин Рикард фон Триллиан, желает видеть вас в своем особняке сегодня ночью."
    rykard_guard_unarmed "Вы наверняка ищете ответы на многие вопросы. И он готов вам в этом помочь."
    narrator "Он кладет приглашение на стойку прямо перед тобой."
    narrator "После этого незнакомец коротко кивает вам троим, разворачивается и молча покидает таверну."
    ...
    willem "Что планируешь делать?"
    narrator "Виллем смотрит на тебя с нескрываемым интересом с примесью страха."
    narrator "Предложение отправиться ночью в особняк неизвестного дворянина тебя безусловно пугает."
    narrator "Но, вместе с тем, обещание получить ответы на вопросы кажется тебе невыносимо заманчивым."
...
label act_1_rykard_gang_counter:
    ...
    if hero.prof == PROF.MONK:
        ...
        narrator "Его лицо меняется едва заметно: насмешка остается, но под ней проступает осторожность."
        narrator "В Морвейне можно не любить Орден. Можно шептаться о нем в трактирах и проклинать его за закрытыми ставнями."
        narrator "Но мало кто настолько глуп, чтобы поднять руку на священника."
