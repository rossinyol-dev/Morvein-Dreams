...
define beggar = Character(_('Нищий'), color="#7c9703")
define stefan = Character(_('Отец Стефан'), color="#b02d2d")
define cultist = Character(_('Культист'), color="#6a4001")
define mattias = Character(_('Брат Маттиас'), color="#19e6db")
define edmund = Character(_('Брат Эдмунд'), color="#0cb314")
define cornelius = Character(_('Брат Корнелиус'), color="#981aca")
define agatha_unknown = Character(_('Торговка'), color="#eb049a")
define agatha = Character(_('Агата'), color="#eb049a")
define rykard = Character(_('Рикард фон Триллиан'), color="#002b7c")
define innkeeper = Character(_('Трактирщик Виллем'), color="#084f0c")
define albert = Character(_('Альберт'), color="#9b6a2f")
define rykard_guard_armed = Character(_('Страж Рикарда'), color="#6f3b3b")
define rykard_guard_unarmed = Character(_('Незнакомец'), color="#6f3b3b")
define gang_leader = Character(_('Главарь'), color="#7a7a7a")
define willem = Character(_('Виллем'), color="#116554")
define gang_leader = Character(_('Главарь банды'), color="#116554")
define minstrel_default = Character(_('Менестрель'), color="#d7bc0e")
